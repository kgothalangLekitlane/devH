...
const publicUser = (user) => ({
  ...
  username: user.username, profileImage: user.profileImage?.startsWith("gridfs:") ? `/api/users/${user._id}/avatar` : user.profileImage,
  bio: user.bio, skills: user.skills, location: user.location, experience: user.experience,
  timezone: user.timezone, socialLinks: user.socialLinks, createdAt: user.createdAt,
});
...
const requestPasswordReset = async (req, res) => {
  try {
    ...
    // Always return the same response so attackers cannot discover registered accounts.
